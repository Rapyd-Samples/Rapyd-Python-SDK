...
class Condition(BaseModel):
    ...
    :param operator: A symbol representing the operator of the condition. String starting with $. The operator determines the relationship between the operands See documentation - https://docs.rapyd.net/build-with-rapyd/reference/payment-method-types#operators-for-conditions, defaults to None
    :type operator: str, optional
    :param threshold_value: One or more possible values of the element_name field. The second operand of the condition https://docs.rapyd.net/build-with-rapyd/reference/payment-method-types#operators-for-conditions, defaults to None
