...
@JsonMap({})
class CustomElements(BaseModel):
    def __init__(
        self,
...
class CheckoutPageResponse(BaseModel):
    def __init__(
        ...
        custom_elements: CustomElements = None,
        ...
        self.amount = amount
        self.cart_items = self._define_object(cart_items, CartItems)
        self.country = (
        ...
        self.custom_elements = self._define_object(custom_elements, CustomElements)
        ...
        self.complete_checkout_url = complete_checkout_url
        self.cancel_checkout_url = cancel_checkout_url
